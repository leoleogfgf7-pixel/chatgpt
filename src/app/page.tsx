  ...
  if (!d) return (
    <div className="flex justify-center items-center py-32">
      <div className="relative">
        ...
        <div className="absolute inset-0 w-12 h-12 rounded-full border-2 border-transparent border-b-indigo-400 animate-spin" style={{ animationDirection: "reverse", animationDuration: "1.5s" }} />
      </div>
    </div>
  );
